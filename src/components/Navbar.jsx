    ...
    <>
      ...
      <div className="w-full h-16 bg-gray-200 flex items-center p-2 gap-4 justify-between px:6 md:px-36 ">
        ...
        <div className="hidden  h-12 w-72 border-2 border-black md:flex items-center bg-white px-2 rounded">
          ...
          <input className="h-full w-full outline-none" placeholder="INDIA" />
          <IoIosArrowDown className="text-3xl" />
        </div>
        <div
          className="hidden h-12 w-96 border-2 border-black md:flex items-center bg-white  rounded"
          style={{ width: "550px" }}
        >
          <input
        ...
        <div className="h-10 w-24 sell flex justify-center items-center rounded-3xl">
          <div
            onClick={haldleSell}
            className=" cursor-pointer h-[82%] w-[86%] bg-white  rounded-3xl flex items-center justify-center gap-1"
          >
            <TiPlus />
